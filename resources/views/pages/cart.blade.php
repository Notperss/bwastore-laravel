              ...
              <tbody>
                <tr>
                  ...
                  <td style="width: 35%">
                    ...
                    <div class="product-subtitle">by Sapa saja</div>
                  </td>
                  <td style="width: 35%">
                    <div class="product-title">$45,242</div>
                ...
                <tr>
                  ...
                  <td style="width: 35%">
                    ...
                    <div class="product-subtitle">by Sapa tu</div>
                  </td>
                  <td style="width: 35%">
                    <div class="product-title">$353</div>
                    <div class="product-subtitle">USD</div>
                  </td>
                  <td style="width: 20%">
                    <a href="#" class="btn btn-remove-cart">Remove</a>
                ...
                <tr>
                  ...
                  <td style="width: 35%">
                    ...
                    <div class="product-subtitle">by Sapa ni</div>
                  </td>
                  <td style="width: 35%">
                    <div class="product-title">$383</div>
                    <div class="product-subtitle">USD</div>
                  </td>
                  <td style="width: 20%">
                    <a href="#" class="btn btn-remove-cart">Remove</a>
