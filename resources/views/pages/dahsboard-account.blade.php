                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="addressOne" name="addressOne" value="Setra" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="addressOne">Your Email</label>
                        <input type="email" class="form-control" id="addressOne" name="addressOne"
                          value="Setra@mail.com" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
