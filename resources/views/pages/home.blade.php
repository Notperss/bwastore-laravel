  ...
  <div class="page-content page-home">
    ...
    <section class="store-trend-categories">
      <div class="container">
        ...
        <div class="row">
          ...
          @empty
            <div class="col-12 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="100">
              No Categories Found
            </div>
          @endforelse
        </div>
    ...
    <section class="store-new-products">
      <div class="container">
        ...
        <div class="row">
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="200">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
              ...
              <div class="products-price">$9,582</div>
            </a>
          </div>
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="300">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
              ...
              <div class="products-price">$52</div>
            </a>
          </div>
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="400">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
          ...
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="500">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
          ...
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="600">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
          ...
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="700">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
          ...
          <div class="col-6 col-md- col-lg-3" data-aos="fade-up" data-aos-delay="800">
            <a href="/details.html" class="component-products d-block">
              <div class="products-thumbnail">
                <div class="products-image"
                  style="
